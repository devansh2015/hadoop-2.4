...
rm)
	validate_keytabfile_rm_nn_function;
        ...
        /usr/bin/kadmin -p createkeytab/admin  -k -t /apache/hadoop/keytabs/createkeytab.keytab -q "addprinc -randkey host/$HOST";
	/usr/bin/kadmin -p createkeytab/admin  -k -t /apache/hadoop/keytabs/createkeytab.keytab -q "addprinc -randkey HTTP/$HOST";
        /usr/bin/kadmin -p createkeytab/admin  -k -t /apache/hadoop/keytabs/createkeytab.keytab -q "ktadd -k /apache/hadoop/keytabs/$HOST/rm.keytab rm/$HOST host/$HOST";
	/usr/bin/kadmin -p createkeytab/admin  -k -t /apache/hadoop/keytabs/createkeytab.keytab -q "ktadd -k /apache/hadoop/keytabs/$HOST/http.keytab HTTP/$HOST";
        chown hdfs:hadoop /apache/hadoop/keytabs/$HOST/http.keytab;
        chmod 400 /apache/hadoop/keytabs/$HOST/http.keytab;
        chown yarn:hadoop /apache/hadoop/keytabs/$HOST/rm.keytab;
        chmod 400 /apache/hadoop/keytabs/$HOST/rm.keytab;;

dn)
	validate_keytabfile_nm_dn_function;	
	/usr/bin/kadmin -p createkeytab/admin  -k -t /apache/hadoop/keytabs/createkeytab.keytab -q "addprinc -randkey dn/$HOST";
	/usr/bin/kadmin -p createkeytab/admin  -k -t /apache/hadoop/keytabs/createkeytab.keytab -q "addprinc -randkey host/$HOST";
	/usr/bin/kadmin -p createkeytab/admin  -k -t /apache/hadoop/keytabs/createkeytab.keytab -q "addprinc -randkey HTTP/$HOST";
	/usr/bin/kadmin -p createkeytab/admin  -k -t /apache/hadoop/keytabs/createkeytab.keytab -q "ktadd -k /apache/hadoop/keytabs/$HOST/dn.keytab dn/$HOST host/$HOST";
        /usr/bin/kadmin -p createkeytab/admin  -k -t /apache/hadoop/keytabs/createkeytab.keytab -q "addprinc -randkey nm/$HOST";
        /usr/bin/kadmin -p createkeytab/admin  -k -t /apache/hadoop/keytabs/createkeytab.keytab -q "ktadd -k /apache/hadoop/keytabs/$HOST/nm.keytab nm/$HOST host/$HOST";
	/usr/bin/kadmin -p createkeytab/admin  -k -t /apache/hadoop/keytabs/createkeytab.keytab -q "ktadd -k /apache/hadoop/keytabs/$HOST/http.keytab HTTP/$HOST";
        chown hdfs:hadoop /apache/hadoop/keytabs/$HOST/dn.keytab;
        chmod 400 /apache/hadoop/keytabs/$HOST/dn.keytab;
	chown hdfs:hadoop /apache/hadoop/keytabs/$HOST/http.keytab;
        chmod 400 /apache/hadoop/keytabs/$HOST/http.keytab;
	chown yarn:hadoop /apache/hadoop/keytabs/$HOST/nm.keytab;
        chmod 400 /apache/hadoop/keytabs/$HOST/nm.keytab;;
